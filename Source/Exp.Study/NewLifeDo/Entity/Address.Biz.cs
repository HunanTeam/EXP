...
namespace Exp.Study.NewLifeDo.Entity
{
    ...
    public partial class Address : Entity<Address>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(Address).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    entity.Company = "abc";
        //    entity.CountryId = 0;
        //    entity.StateProvinceId = 0;
        //    entity.CityId = 0;
        //    entity.Address1 = "abc";
        //    entity.ZipPostalCode = "abc";
        //    entity.PhoneNumber = "abc";
        //    entity.MobileNumber = "abc";
        //    entity.FaxNumber = "abc";
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(Address).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        [NonSerialized]
        private User _User;
        /// <summary>该Address所对应的User</summary>
        [XmlIgnore]
        public User User
        {
            get
        ...
        /// <summary>该Address所对应的UserName</summary>
        [XmlIgnore]
        ...
        /// <summary>根据UserId查找</summary>
        /// <param name="userid"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Address> FindAllByUserId(Int32 userid)
        {
            if (Meta.Count >= 1000)
