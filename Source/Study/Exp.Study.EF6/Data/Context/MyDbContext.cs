...
namespace Exp.Study.EF6.Data.Context
{
    public class MyDbContext : DbContext,IDbContext
    {
        ...
        public IList<TEntity> ExecuteStoredProcedureListWithOutAttachEntityToContext<TEntity>(string commandText, params object[] parameters) where TEntity : BaseEntity, new()
        {
            //HACK: Entity Framework Code First doesn't support doesn't support output parameters
            //That's why we have to manually create command and execute it.
            //just wait until EF Code First starts support them
