...
namespace Exp.Data
{
    ...
    ///     单元操作实现
    /// </summary>
    public  class EFRepositoryContextBase : IEFRepositoryContext
    {
        public EFRepositoryContextBase(string connectionString)
        {
            this.DbContext = new EFDbContextBase(connectionString);
        }
        ...
        public int Commit(bool validateOnSaveEnabled = true)
        {
            ...
            try
            {
                int result = DbContext.SaveChanges(validateOnSaveEnabled);
                IsCommitted = true;
                return result;
            }
        ...
        {
            System.Data.Entity.EntityState state = DbContext.Entry(entity).State;
        ...
        {
            DbContext.Update<TEntity, TKey>(entity);
            IsCommitted = false;
        }
        ...
        {
            DbContext.Update<TEntity, TKey>(propertyExpression, entity);
            IsCommitted = false;
        }
